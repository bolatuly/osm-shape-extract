...
if __name__ == '__main__':
    ...
    'college':6, 'church': 7, 'retail':8, 'public':9, 'roof':10, 'office':11, 'residential':12,
    'dormitory':13, 'warehouse':14, 'hospital':15, 'civic': 16, 'supermarket':17, 'train_station':18,
    'kindergarten':19, 'hotel':20, 'gate':21, 'construction':22, 'industrial':23, 'house':24,
    'stadium':25, 'garage':26, 'manufacture':27, 'transportation':28, 'service':29, 'shed':30,
    'hangar':31, 'bunker':32, 'terrace':33, 'garages':34, 'cathedral':35, 'barn':36, 'detached':37,
    'restaurant':38}}
